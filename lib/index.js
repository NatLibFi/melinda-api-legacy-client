...
(function(root, factory) {
  ...
  }(this, function(Q, axios, marc_record_converters, urljoin, btoa, xmldom) {
    "use strict";
    ...
    function constructor(config) {
      ...
      function loadRecord(id, params, raw) {
        ...
        axios.get(url, opts).then(function(response) {
          ...
          try {
            var record = marc_record_converters.marc21slimXML.from(response.data);
        ...
        axios.get(url, opts).then(function(response) {
          ...
          try {
            ...
            for (var i=0;i < collection_children.length; i++) {
              records.push(marc_record_converters.marc21slimXML.from(
      ...
      function createRecord(record, params) {
        ...
        try {
          var inMARCXML = marc_record_converters.marc21slimXML.to(record);
